    ...
    <v-card class="ds-calendar-event-popover-card"
        ...
        <v-toolbar extended flat
            ...
            <slot name="eventPopoverToolbarActions" v-bind="slotData">
                <v-tooltip bottom v-if="!isReadOnly">
                    <ds-schedule-actions slot="activator"
                                         v-bind="{$scopedSlots}"
                                         v-on="$listeners"
        ...
        <v-card-text>
            ...
            <v-list dense>
                ...
                <v-list-tile v-if="details.DiaDiem">
                    <v-list-tile-avatar>
                    ...
                    <v-list-tile-content>
                        <slot name="eventPopoverLocation" v-bind="slotData">
                            <v-list-tile-title>
                                <span v-html="details.DiaDiem"></span>
                            </v-list-tile-title>
                        </slot>
                    </v-list-tile-content>
                </v-list-tile>
                <v-list-tile v-if="details.ThanhPhan">
                    <v-list-tile-avatar>
                        <v-icon>group</v-icon>
                    </v-list-tile-avatar>
                    <v-list-tile-content>
                        <slot name="eventPopoverDescription" v-bind="slotData">
                            <v-list-tile-title>
                                <span v-html="details.ThanhPhan"></span>
                            </v-list-tile-title>
                        </slot>
                    </v-list-tile-content>
                </v-list-tile>
                <v-list-tile v-if="details.ChuTri">
                    <v-list-tile-avatar>
                        <v-icon>gavel</v-icon>
                    </v-list-tile-avatar>
                    <v-list-tile-content>
                        <slot name="eventPopoverNotifications" v-bind="slotData">
                            <v-list-tile-title>
                                <span v-html="details.ChuTri"></span>
                            </v-list-tile-title>
                        </slot>
                    </v-list-tile-content>
                </v-list-tile>
                <v-list-tile v-if="details.NoiDung">
                    <v-list-tile-avatar>
                        <v-icon>list</v-icon>
                    </v-list-tile-avatar>
                    <v-list-tile-content>
                        <slot name="eventPopoverCalendar" v-bind="slotData">
                            <v-list-tile-title>
                                <span v-html="details.NoiDung"></span>
                            </v-list-tile-title>
                        </slot>
                    </v-list-tile-content>
                </v-list-tile>
...
<script>
    ...
    export default {
        ...
        computed:
        {
            ...
            startDate() {
                return this.calendarEvent.start.format('dddd, DD/MM/YYYY');
            },
